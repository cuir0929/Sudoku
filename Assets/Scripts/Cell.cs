...
public class Cell : MonoBehaviour
{
    ...
    [Header("Text Colors")]
    [SerializeField] private Color initialNumberColor = new Color(0.4f, 0.25f, 0.15f, 1f);    // 深棕色 (#663F26)
    [SerializeField] private Color correctNumberColor = new Color(0.2f, 0.4f, 0.2f, 1f);      // 深绿色 (#336633)
    [SerializeField] private Color incorrectNumberColor = new Color(0.7f, 0.2f, 0.2f, 1f);    // 深红色 (#B33333)
    [SerializeField] private Color winNumberColor = new Color(0.25f, 0.35f, 0.6f, 1f);        // 深蓝色 (#405C99)
